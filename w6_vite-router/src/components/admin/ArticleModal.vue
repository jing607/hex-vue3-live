            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="author"  placeholder="請輸入標題" v-model="tempArticle.author"/>
                </div>
                <div class="mb-3">
              ...
              <div class="col-sm-8">
                  ...
                  <div class="col-md-2 mb-1" v-for="(label, key) in tempArticle.tag" :key="key">
                    <div class="input-group input-group-sm">
                      <input type="text" class="form-control form-control" 
                        placeholder="請輸入標籤" v-model="tempArticle.tag[key]"/>
                ...
                <div class="mb-3">
                  ...
                  <textarea type="text" class="form-control" id="description" 
                    placeholder="請輸入文章描述" v-model="tempArticle.description"></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" v-model="tempArticle.isPublic"/>
...
export default {
    ...
    watch: {
      article() {
        this.tempArticle = {
          ...this.article,
          // 當 tag 和 isPublic 在 article 中沒有值的時候，在 this.tempArticle 中也會被正確地初始化為一個空陣列和 false
